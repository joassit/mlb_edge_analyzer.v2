...
TODO lo necesario para el Technical Performance Report de 2026-07-22 --
usando exclusivamente las funciones OFICIALES de tracking/results_tracker.py
(nunca recalculando a mano).
"""
import base64
import gzip
import json
...
try:
    ...
    # Descomposición del juego con mayor edge real de hoy (no de TODOS,
