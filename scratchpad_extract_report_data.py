...
Postgres real de producción -- secrets.DATABASE_URL, migrado el 2026-07-19
desde el mlb_edge.db legacy y alimentado en vivo por daily_pipeline.yml
desde entonces) que arma un JSON con TODO lo necesario para el Technical
Performance Report de 2026-07-20 -- usando exclusivamente las funciones
OFICIALES de tracking/results_tracker.py (nunca recalculando a mano).
"""
import base64
import gzip
import json
