...
migrate_v07.py/migrate_v08.py/migrate_v09.py, para poder aplicar el cambio
...
_NEW_COLUMNS = ["calibration_phase"]
...
def migrate():
    ...
    if not missing:
        print("calibration_phase ya existe -- no hace falta migrar.")
        return
