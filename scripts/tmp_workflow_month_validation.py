...
Segundo intento -- el primero crasheo por un bug real de idempotencia en
ingestion.py (UNIQUE constraint con un juego suspendido/reprogramado
apareciendo en el calendario de dos días distintos), ya corregido y con
test de regresión.
"""
